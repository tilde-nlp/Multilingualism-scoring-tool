...
class TestAnalyzer(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        body = '<!DOCTYPE html><html lang="lv"><head><title>Teksts latviešu valodā.</title></head><body><h1>Testa lapa teksta izvilkšanas un valodas noteikšanas pārbaudei.</h1><p>Daudz vairāk teksta latviešu valodā.</p><p>Vēl vairāk teksta latviešu valodā.</p></body></html>'
